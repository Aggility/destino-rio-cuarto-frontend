...
export default function EventCard({ 
  ...
  return (
    <div className="card h-100 border-0 bg-transparent shadow-none" style={{ width: '318px' }}>
      
      {/* 1. Header (Thumbnail & Tag) — Figma ID I3781:19227;3389:3472 */}
      <div className="position-relative overflow-hidden rounded-2 mb-2" style={{ height: '207px', borderRadius: '8px' }}>
        <Image 
          src={thumbnail}
          alt={title}
          fill
          className="object-cover transition-transform duration-500 animate-hover-lift"
        />

...
const CATEGORY_COLOR = '#ff5a1f';

/**
 * ExperiencesListClient - Destino Río Cuarto
 * Componente cliente que maneja búsqueda y filtro por categoría
 * de las experiencias (proposals) consumidas desde la API.
 */
export default function ExperiencesListClient({ initialActivities = [], categories = [] }) {
            ...
            <div className="col-12 col-md-7 col-xl-6">
              <div className="input-group shadow-sm" style={{ height: '52px' }}>
                ...
                <input
                  ...
                  placeholder="Buscar experiencias, paseos..."
                  value={searchTerm}
        ...
        <div className="container-xxl px-3 px-lg-5">
          ...
          {filtered.length > 0 ? (
            ...
            <div className="text-center py-5 bg-white rounded-4 border shadow-sm">
              ...
              <h5 className="font-inter fw-bold text-gray-800 mb-2">No encontramos experiencias</h5>
